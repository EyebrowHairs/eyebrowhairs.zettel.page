...
- Started 2020-08-01
- Type: tech
- There is only a month or so left until school starts, so I figured that I should get back into learning Python while I still have time. Honestly, I have started many times but could never maintain the motivation to continue. Hopefully the time limit will motivate me this round. 
- Resource: “Automate the Boring Stuff” because it seems to be the most practical of other courses. I  am no longer overly interested in learning the computer science side of it, just the practical part so it should be a good fit. Another resource I am using is One Month, because I was able to access it via the Github education plan.
- Plans: I set a goal to set aside an hour every other day to work on the course. After after reviewing it so many times, I should have the basics down,  so hopefully I can get to the projects more quickly.
...
- [x] Finish reading Grad School Essentials
